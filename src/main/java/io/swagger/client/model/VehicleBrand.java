...
public class VehicleBrand {
  ...
  public VehicleBrand id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
   ...
   * @return name
  **/
  @Schema(example = "Irisbus", description = "")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, vehicleBrand.id) &&
        Objects.equals(this.name, vehicleBrand.name);
  }
